...
iter <- function(iternum, defC, defC2, basestudy, nsites, sm){
  ...
  data.table(iternum,Delta.perc,delta.perc,beta.perc,div) 
}

rt <- stanc("/gpfs/home/dw2625/r/cov_test3.stan");
...
save(site_plasma, file = paste0("/gpfs/home/dw2625/r/", date_stamp, "/cov_test3.rda"))
