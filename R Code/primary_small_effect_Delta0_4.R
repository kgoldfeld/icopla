...
iter <- function(iternum, defC, defC2, basestudy, nsites, sm){
  ...
  data.table(iternum,Delta.perc,delta.perc,alpha.perc,alpha.mean,beta.perc,div) 
}

rt <- stanc("/gpfs/home/dw2625/r/primary_1027.stan");
...
save(site_plasma, file = paste0("/gpfs/home/dw2625/r/", date_stamp, "/primary_smalleffect_2070.rda"))
