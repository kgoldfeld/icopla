...
genBaseProbs <- function(n, base, similarity = 5, digits = 2) {
  ...
  x <- gtools::rdirichlet(n, similarity * base) #n series of random number from Dirichlet distribution, sums close to 1;
...
basestudy <- genBaseProbs(n = 9, base = c(0.03, 0.03, 0.06, 0.09, 0.09, .15, .15, .13, .10, .10, .07))
