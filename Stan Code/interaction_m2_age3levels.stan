...
parameters {
  ...
  real tau[K];       // cut-points for cumulative odds model (K X [L-1] matrix)
...
transformed parameters{ 
  ...
  vector[2] gamma[3];       // control-specific age effect (3 X 2 matrix)
...
generated quantities {
  vector[2] gd_c[3];       // control-specific age effect (3 X 2 matrix)
  vector[2] GD;
